...
<link  rel="stylesheet" href="css/inprocesstaskemp.css" type="text/css">
<style type="text/css"> <%@include file="css/inprocesstaskemp.css" %> </style>
</head>
<body>
 <%
       		Connection cn = null;
       ...
       %>
<form name="inprocesstaskemp" action="inprocesstaskemp" method="post">
    <div class="mydiv">
    ...
    <div class="yourdiv">
        ...
        <input type="number" name="progress" class="bar" placeholder="Enter Progress Percentage" min="0" max="100" >
        <div class="progress-bar"  style="width: <%=rs.getString("percentage") %>%;">
    <div class="progress"><%=rs.getString("percentage") %>%</div>
    </div>
    <div class="inputbox">
	  <label for="taskstatus" >Task Status:</label>
	  <select name="taskstatus" id="taskstatus" class="input" >
